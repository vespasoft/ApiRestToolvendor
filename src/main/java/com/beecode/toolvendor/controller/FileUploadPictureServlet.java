...
public class FileUploadPictureServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
       ...
       for (Part part : parts) {
            ...
            /*if ( !imageValidator.validate(imageName) ) {
                ...
                String fileName = "visitpicture/" + token;
                // se crea la respuesta json con los datos de la imagen subida
                printJSONPart(part, out, fileName, tokenId, id);
    ...
    private void printJSONPart(Part part, PrintWriter pw, String name, String tokenId, String id) {
        Map<String, Object> data = new HashMap<String, Object>();

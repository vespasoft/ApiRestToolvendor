...
import com.beecode.toolvendor.dao.BrandDAO;
import com.beecode.toolvendor.interfaces.BrandService;
...
public class BrandServiceImpl implements BrandService {
    ...
    public String save(Brand obj) {
        ...
        if ( obj==null ) {
        ...
        } else if ( obj.getBrand()==null ) {
            message="El campo Brand no puede estar vacio";
        } else if ( obj.getBrand().length()==0 ) {
            message="El campo Description no puede estar vacio";
        } else if ( findName(obj.getBrand(), obj.getCompanyId()) ) {
            ...
            current = dao.findByName(obj.getBrand(), obj.getCompanyId());
            if ( current==null) {
    ...
    public String update(Brand obj) {
        ...
        if ( obj==null ) {
            message="Se espero un objeto Brand en formato JSON";
        } else if ( obj.getBrand()==null ) {
            message="El campo Brand no puede estar vacio";
        } else if ( obj.getBrand().length()==0 ) {
            message="El campo Description no puede estar vacio";
    ...
    public Brand findById(int id, int companyId) {
        ...
        try {
            ...
            System.out.println("Error in brand findById: " + e.getMessage());
        }
    ...
    public Brand findByName(String name, int companyId) {
        ...
        try {
            ...
            System.out.println("Error in brand findByName: " + e.getMessage());
        }
    ...
    public boolean delete(int id) {
        ...
        try {
            ...
            System.out.println("Error in brand delete: " + e.getMessage());
        }
